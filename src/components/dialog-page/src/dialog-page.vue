<template>
  <div class="page-modal">
    ...
    >
      ...
      <!-- 表单 -->
      <commen-form v-model="formDate" v-bind="modalConfig" ref="commenFormRef">
        <!-- 在page-content中动态插入剩余的插槽，页面单独的插槽 -->
        <template v-for="item in modalConfig" :key="item.field" #[item.slotName]="scope">
